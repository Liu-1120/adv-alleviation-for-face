...
if __name__ == '__main__':
    ...
    from model_resgn_facenet import Model
    ...
    with tf.Session() as sess:
        ...
        pretrained_model = 'facenet\\20170512-110547\\'
        if pretrained_model:
        ...
        for ibatch in range(batch_number):
            ...
            real_labels = sess.run(model.pre_softmax, feed_dict=feed_dict)
            accuracy1 = np.mean(
